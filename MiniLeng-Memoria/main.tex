...
\input{secciones/lexico}
\input{secciones/sintactico}
\input{secciones/tabla-simbolos}
\input{secciones/semantico}
\input{secciones/generacion-codigo}
\input{secciones/mejoras-introducidas}
\pagebreak
