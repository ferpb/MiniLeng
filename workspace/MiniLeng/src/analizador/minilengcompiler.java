...
public class minilengcompiler implements minilengcompilerConstants {
        ...
        private static final String fecha_version = "agosto de 2020";
        ...
        try {
            ...
            System.err.println("Cabeza de lectura: (l\u00ednea " + token.beginLine + ", columna " + token.beginColumn + ") " + token);
                throw e;
                        ...
                        ErrorLexico.deteccion(entrada.getEndLine(), entrada.getEndColumn() + 1, error, TokenMgrError.addEscapes(error));
                }
