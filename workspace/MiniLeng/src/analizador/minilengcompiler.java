 ...
 */
  static final public int programa() throws ParseException {int nivel = 0;
...
// Declaraciones de separadores y limitadores de bloque
  static final public 
void fin_sentencia() throws ParseException {
    try {
...
ErrorSintactico.deteccion(e, "Se esperaba ']'");
  ...
  static final public Integer longitud_const() throws ParseException {Token t;
  Integer len = null;
    try {
...
ErrorSintactico.deteccion(e, "Se esperaba el delimitador fin de bloque: 'fin'");
  ...
  static final public Token identificador() throws ParseException {Token t = null;
    try {
 ...
 */
  static final public void declaracion() throws ParseException {Tipo_variable tipo;
 ...
 */
  static final public Tipo_variable tipo_variables() throws ParseException {Tipo_variable variable = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case tENTERO:{
 ...
 */
  static final public void identificador_declaracion(Tipo_variable tipo) throws ParseException {Token id = null;
  Integer len = null;
    try {
      id = identificador();
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
 ...
 */
  static final public ListaInstr declaracion_acciones() throws ParseException {ListaInstr l = new ListaInstr();
 ...
 */
  static final public ListaInstr declaracion_accion() throws ParseException {Token t = token.next;
 ...
 */
  static final public ListaInstr cabecera_accion() throws ParseException {Token id;
  Simbolo s = null;
 ...
 */
  static final public ArrayList<Simbolo> parametros_formales(Simbolo s) throws ParseException {ArrayList<Simbolo> parametros;
 ...
 */
  static final public ArrayList<Simbolo> parametros(Simbolo s) throws ParseException {Clase_parametro clase;
  Tipo_variable tipo;
 ...
 */
  static final public ArrayList<Simbolo> lista_parametros(Clase_parametro clase, Tipo_variable tipo, Simbolo s) throws ParseException {ArrayList<Simbolo> listaParametros = new ArrayList<Simbolo>();
 ...
 */
  static final public Clase_parametro clase_parametros() throws ParseException {Clase_parametro clase = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case tVAL:{
 ...
 */
  static final public Simbolo identificador_parametro(Clase_parametro clase, Tipo_variable tipo, Simbolo s) throws ParseException {Token id;
  Integer len = null;
  Simbolo par = null;
    try {
      id = identificador();
 ...
 */
  static final public ListaInstr bloque_sentencias() throws ParseException {ListaInstr l = new ListaInstr();
    try {
      principio();
      l = lista_sentencias();
      fin();
 ...
 */
  static final public ListaInstr lista_sentencias() throws ParseException {ListaInstr l = new ListaInstr();
 ...
 */
  static final public ListaInstr sentencia() throws ParseException {ListaInstr l = new ListaInstr();
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case tLEER:{
        l = leer();
 ...
 */
  static final public ListaInstr leer() throws ParseException {Token t;
 ...
 */
  static final public ArrayList<RegistroExpr> lista_asignables(Token t) throws ParseException {ArrayList<RegistroExpr> listaExpr = new ArrayList<RegistroExpr>();
...
{if ("" != null) return listaEscribibles;}
    throw new Error("Missing return statement in function");
}
 ...
 */
  static final public ListaInstr escribir() throws ParseException {ArrayList<RegistroExpr> listaExpr = new ArrayList<RegistroExpr>();
 ...
 */
  static final public ArrayList<RegistroExpr> lista_escribibles() throws ParseException {RegistroExpr reg;
  ArrayList<RegistroExpr> listaExpr = new ArrayList<RegistroExpr>();
    try {
 ...
 */
  static final public RegistroExpr escribible() throws ParseException {RegistroExpr reg = null;
  Token t;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case tENTACAR:
 ...
 */
  static final public ListaInstr mientras_que() throws ParseException {Token t;
  RegistroExpr reg;
  Boolean ok = true;
 ...
 */
  static final public ListaInstr seleccion() throws ParseException {Token t;
  RegistroExpr reg;
 ...
 */
  static final public ListaInstr identificacion() throws ParseException {Token t;
 ...
 */
  static final public ListaInstr asignacion(Simbolo s, RegistroExpr indice, Token izq) throws ParseException {RegistroExpr reg;
  Token t;
 ...
 */
  static final public ListaInstr argumentos(Simbolo s, Token t) throws ParseException {ArrayList<RegistroExpr> listaExpr = null;
 ...
 */
  static final public ArrayList<RegistroExpr> lista_expresiones() throws ParseException {ArrayList<RegistroExpr> listaExpr = new ArrayList<RegistroExpr>();
  RegistroExpr reg;
    try {
 ...
 */
  static final public RegistroExpr expresion() throws ParseException {RegistroExpr reg1 = new RegistroExpr();
 ...
 */
  static final public RegistroOp operador_relacional() throws ParseException {Token t;
  RegistroOp op = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case tIGUAL:{
 ...
 */
  static final public RegistroExpr expresion_simple() throws ParseException {RegistroExpr reg1 = new RegistroExpr();
  RegistroExpr reg2 = new RegistroExpr();
  RegistroOp op;
    try {
      reg1 = termino();
 ...
 */
  static final public RegistroOp operador_aditivo() throws ParseException {Token t;
  RegistroOp op = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case tMAS:{
 ...
 */
  static final public RegistroExpr termino() throws ParseException {RegistroExpr reg1 = null;
  RegistroExpr reg2;
  RegistroOp op;
    try {
      reg1 = factor();
 ...
 */
  static final public RegistroOp operador_multiplicativo() throws ParseException {Token t;
  RegistroOp op = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case tPRODUCTO:{
 ...
 */
  static final public RegistroExpr factor() throws ParseException {Token t = null;
  Simbolo s;
  RegistroExpr indice = null;
